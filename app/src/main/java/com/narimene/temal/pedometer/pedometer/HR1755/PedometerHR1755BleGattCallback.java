package com.narimene.temal.pedometer.pedometer.HR1755;
...
import fr.semantic.ecare.app.android.components.sensor.pedometer.HR1755.modes.CommandBleNotifyCallbackHR1755;
...
/**
 * Service that handles Bluetooth communications with J-Style HR-1755 pedometers.
 */

public class PedometerHR1755BleGattCallback extends SensorBleGattCallback {

    public final static String TAG = PedometerHR1755BleGattCallback.class.getSimpleName();
    ...
    public PedometerHR1755BleGattCallback(Sensor.SensorModel sensorModel) {
        super(sensorModel);
        initializationNecessaryData();
    }

    public PedometerHR1755BleGattCallback(Sensor.SensorModel sensorModel, int mCounterConnexion) {
    ...
    public void changeToCommandMode(){
        ...
        mBleNotifyCallback = new CommandBleNotifyCallbackHR1755(this);
    ...
    public void changeToSynchronizeMode(){
        removeNotifyCallBack();
        mBleNotifyCallback = new SynchronizeBleNotifyCallbackHR1755(this);
    ...
    public boolean isCommandMode(){
        if (mBleNotifyCallback instanceof CommandBleNotifyCallbackHR1755)
            return true;
        else
            return false;
    }
